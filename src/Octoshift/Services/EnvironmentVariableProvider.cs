...
public class EnvironmentVariableProvider
{
    ...
    private const string GL_PAT = "GL_PAT";
    private const string GL_USERNAME = "GL_USERNAME";
    ...
    public virtual string GitlabPersonalAccessToken(bool throwIfNotFound = true) =>
